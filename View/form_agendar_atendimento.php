        ...
        <form action="../Models/atendimento.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="hora" name="hora" required>
                    ...
                    <?php
                    $horarios_disponiveis = ["14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00"];
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Explique brevemente o motivo do atendimento..." required></textarea>
            </div>
